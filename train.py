...
def main(args):
    ...
    if DALI:
        ...
        d_train = data_loader_train
        d_test =  data_loader_test
    ...
    optimizer = torch.optim.SGD([{"params":params["biases"], "lr":args.lr, "momentum":args.momentum},{"params": params["conv_weights"], "weight_decay": wd},{"params": params["others"]}])
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ckpt-path",default="yolov5s_official_2cf45318.pth") # basic checkpoint path
